  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50/50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {!configStatus.gemini && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex flex-col sm:flex-row items-start gap-4 shadow-sm animate-pulse">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-1 mb-2">
                  To run the app, create a <code>.env</code> file in the project root and add your <code>API_KEY</code>.
                </p>
              </div>
            </div>
            <a 
