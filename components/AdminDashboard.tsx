...
-- 3. UPDATE TRIGGER (Strict Lowercase Handling)
...
begin
  ...
  values (
    ...
    is_invited, -- If invite exists, TRUE.
    false
  );
  return new;
end;
...
-- 4. RE-CREATE RPC FUNCTION (Fail-safe for Setup)
...
-- 5. FIX PERMISSIONS (The "God Mode" Bypass for tadekus@gmail.com)
-- This ensures you can ALWAYS insert invites, even if the DB flags are wrong.
...
-- 6. VISIBILITY POLICY
-- Ensures invited users can see their own invite to complete setup
      ...
      <div className="mt-12 pt-8 border-t border-slate-200">
        ...
        {showSql && (
          <div className="mt-4 bg-slate-900 rounded-lg p-6">
            ...
            <p className="text-slate-400 text-xs mb-4">
              Run this SQL in Supabase to fix permissions and ensure the &quot;Invited users = Superusers&quot; flow works.
            </p>
